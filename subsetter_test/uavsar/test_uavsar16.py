...
# Temporal subset test subset=time(%222016-11-17T23%3A27%3A00Z%22%3A%222016-11-17T23%3A28%3A00Z%22)
@pytest.fixture()
def info():
    global expected
    global product
...
def test_uavsar_status(harmony_url_config):
    ...
    harmony_url = base + uavsar_id + '/ogc-api-coverages/1.0.0/collections/all/coverage/rangeset?subset=time(%222016-11-17T23%3A27%3A00Z%22%3A%222016-11-17T23%3A28%3A00Z%22)&subset=lat(28.9:29.0)&subset=lon(-89.1:-88.9)&format=image%2Ftiff'
    global outfile
    outfile = harmony_url_config.env_flag + '_uavsar_query16.tiff'
