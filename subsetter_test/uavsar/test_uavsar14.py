...
# South America: Spatial subset that extends past west boundary of granule bounding box
@pytest.fixture()
def info():
    global expected
    global product
...
def test_uavsar_status(harmony_url_config):
    ...
    harmony_url = base + uavsar_id + '/ogc-api-coverages/1.0.0/collections/all/coverage/rangeset?subset=lat(-40.05:-39.27)&subset=lon(-72.4:-71.9)&format=image%2Ftiff&granuleID=' + granule_id
    global outfile
    outfile = harmony_url_config.env_flag + '_uavsar_query14.tiff'
