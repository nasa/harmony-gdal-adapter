...
def test_uavsar_status(harmony_url_config):
    ...
    harmony_url = base + uavsar_id + '/ogc-api-coverages/1.0.0/collections/all/coverage/rangeset?subset=lat(63.9:63.95)&subset=lon(-150:-149)&format=image%2Ftiff&granuleID=' + granule_id
    global outfile
    outfile = harmony_url_config.env_flag + '_uavsar_query11.tiff'
