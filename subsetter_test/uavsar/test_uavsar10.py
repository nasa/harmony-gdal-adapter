...
def test_uavsar_status(harmony_url_config):
    ...
    if harmony_url_config.env_flag == 'prod':
        granule_id = 'G1555903037-ASF'
    else:
        granule_id = 'G1233284335-ASF'

    harmony_url = base + uavsar_id + '/ogc-api-coverages/1.0.0/collections/Band1%2CBand3/coverage/rangeset?subset=lat(63.9:63.95)&subset=lon(-150:-149)&format=image%2Ftiff&granuleID=' + granule_id
    global outfile
    outfile = harmony_url_config.env_flag + '_uavsar_query10.tiff'
