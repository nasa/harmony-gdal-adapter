...
def info():
    ...
    expected =  {'cs': 'Geographic',
                 ...
                 'proj_epsg': 'NA',
                 'gcs_epsg': '4326',
                 'subset': [63.75, 64.25, -146.07, -145.8],
                 'bands': 1,
...
def test_uavsar_status(harmony_url_config):
    ...
    harmony_url = base + uavsar_id + '/ogc-api-coverages/1.0.0/collections/Band2/coverage/rangeset?subset=lat(63.75:64.25)&subset=lon(-146.07:-145.8)&format=image%2Ftiff&granuleID=' + granule_id
    global outfile
    outfile = harmony_url_config.env_flag + '_uavsar_query2.tiff'
