...
#Negative longitude spatial subset xy size
...
def info():
    ...
    expected = {'cs': 'Projected',
                ...
                'proj_epsg': '32614',
                'gcs_epsg': '4326',
                'subset': [49.65, 49.95, -97.65, -97.35],
                'bands': 4,
                'xy_size': [90, 45],
...
def test_avnir_status(harmony_url_config):
    ...
    harmony_url = base + avnir_id + '/ogc-api-coverages/1.0.0/collections/Band1%2CBand2%2CBand3%2CBand4/coverage/rangeset?subset=lat(49.65:49.95)&subset=lon(-97.65:-97.35)&format=image%2Ftiff&height=45&width=90&granuleID=' + granule_id
    global outfile
    outfile = harmony_url_config.env_flag + '_avnir_query8.tiff'
