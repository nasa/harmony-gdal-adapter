...
def test_avnir_status(harmony_url_config):
    ...
    harmony_url = base + avnir_id + '/ogc-api-coverages/1.0.0/collections/Band1%2CBand2/coverage/rangeset?subset=lat(-.05:0.25)&subset=lon(-51.0:-50.75)&format=image%2Fpng&granuleID=' + granule_id
    global outfile
    outfile = harmony_url_config.env_flag + '_avnir_query13'
...
@mark.avnir
@mark.png_out
def test_avnir_png_out(harmony_url_config):
    image_type =''
    path = './avnir/avnir_products/'
    global outfile
    outfile = harmony_url_config.env_flag + '_avnir_query13'
