...
#Northern Hemisphere spatial subset
...
def test_avnir_status(harmony_url_config):
    ...
    if harmony_url_config.env_flag == 'prod':
        granule_id = 'G1849288272-ASF'
    else:
        granule_id = 'G1236469517-ASF'


    harmony_url = base + avnir_id + '/ogc-api-coverages/1.0.0/collections/Band4/coverage/rangeset?subset=lat(36.9:37.1)&subset=lon(-99.15:-98.85)&format=image%2Ftiff&granuleID=' + granule_id
    global outfile
    outfile = harmony_url_config.env_flag + '_avnir_query4.tiff'
