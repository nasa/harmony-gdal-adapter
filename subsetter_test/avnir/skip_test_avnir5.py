...
def test_avnir_status(harmony_url_config):
    ...
    harmony_url = base + avnir_id + '/ogc-api-coverages/1.0.0/collections/all/coverage/rangeset?subset=lat(36.95:37.05)&subset=lon(-99.2:-98.9)&format=image%2Ftiff&granuleID=' + granule_id
    global outfile
    outfile = harmony_url_config.env_flag + '_avnir_query5.tiff'
