...
#Southern Hemisphere spatial subset and xy_size
...
def test_avnir_status(harmony_url_config):
    ...
    harmony_url = base + avnir_id + '/ogc-api-coverages/1.0.0/collections/Band1%2CBand3/coverage/rangeset?subset=lat(-26.1:-25.8)&subset=lon(18.07:18.25)&format=image%2Ftiff&height=30&width=75&granuleID=' + granule_id
    global outfile
    outfile = harmony_url_config.env_flag + '_avnir_query6.tiff'
