...
def test_grfn_status(harmony_url_config):
    ...
    harmony_url = base + grfn_id + '/ogc-api-coverages/1.0.0/collections/science%2Fgrids%2Fdata%2Famplitude%2Cscience%2Fgrids%2Fdata%2Fcoherence%2Cscience%2Fgrids%2Fdata%2FconnectedComponents/coverage/rangeset?format=image%2Ftiff&subset=lat(33.05:33.1)&subset=lon(-115.52:-115.27)&height=30&width=75&granuleID=' + granule_id

    global outfile
    outfile = harmony_url_config.env_flag + '_grfn_query6.tiff'
