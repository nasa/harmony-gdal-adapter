...
# China spatial subset area spans east side of product bounding box and 'all' variables
@pytest.fixture()
def info():
    global expected
    global product
...
def test_grfn_status(harmony_url_config):
    ...
    harmony_url = base + grfn_id + '/ogc-api-coverages/1.0.0/collections/all/coverage/rangeset?subset=lat(43.9:44.4)&subset=lon(87.25:92.0)&format=image%2Ftiff&granuleID=' + granule_id

    global outfile
    outfile = harmony_url_config.env_flag + '_grfn_query11.tiff'
