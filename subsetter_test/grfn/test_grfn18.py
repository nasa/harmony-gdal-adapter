...
def test_grfn_status(harmony_url_config):
    ...
    harmony_url = base + grfn_id + '/ogc-api-coverages/1.0.0/collections/science%2Fgrids%2Fdata%2Famplitude/coverage/rangeset?subset=lat(33:33.1)&subset=lon(-115.5:-115.25)&format=image%2Fgif&granuleID=' + granule_id
    global outfile
    outfile = harmony_url_config.env_flag + '_grfn_query18'
...
@mark.grfn
@mark.gif_out
def test_grfn_gif_out(harmony_url_config):
    image_type =''
    path = './grfn/grfn_products/'
    global outfile
    outfile = harmony_url_config.env_flag + '_grfn_query18'
