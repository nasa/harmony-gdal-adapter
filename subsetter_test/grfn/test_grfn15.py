...
# Test case where subset bbox extends past extent of granule on 3 sides
@pytest.fixture()
def info():
    global expected
    global product
    expected =  {'cs': 'Geographic',
                 ...
                 'proj_epsg': 'NA',
                 'gcs_epsg': '4326',
                 'subset': [32.57, 34.46, -115.5, -113.69],
                 'bands': 1,
...
def test_grfn_status(harmony_url_config):
    ...
    harmony_url = base + grfn_id + '/ogc-api-coverages/1.0.0/collections/science%2Fgrids%2Fdata%2Famplitude/coverage/rangeset?subset=lat(32.0:35.0)&subset=lon(-115.5:-113.0)&format=image%2Ftiff&granuleID=' + granule_id
    global outfile
    outfile = harmony_url_config.env_flag + '_grfn_query15.tiff'
