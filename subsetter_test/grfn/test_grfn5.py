...
def test_grfn_status(harmony_url_config):
    ...
    harmony_url = base + grfn_id + '/ogc-api-coverages/1.0.0/collections/science%2Fgrids%2Fdata%2Famplitude%2Cscience%2Fgrids%2Fdata%2Fcoherence/coverage/rangeset?format=image%2Ftiff&subset=lat(33:33.1)&subset=lon(-115.5:-115.25)&height=60&width=150&granuleID=' + granule_id
    
    global outfile
    outfile = harmony_url_config.env_flag + '_grfn_query5.tiff'
