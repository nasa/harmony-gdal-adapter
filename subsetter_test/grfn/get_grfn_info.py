def get_grfn_info(infile):
    from osgeo import gdal
    import osr
    from pyproj import Transformer
    path = './grfn/grfn_products/'
    ds = gdal.Open(path+infile)
    ...
    if proj.IsProjected() == 1 and proj.IsGeographic() == 0:
        ...
        #Transform spatial extent from projected to lat, long (WGS84) to compare with input parameters
